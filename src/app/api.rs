...
impl App {
    ...
    pub(crate) fn focus_pane_for_api(
        ...
        self.emit_focus_status_change(ws_idx, pane_id, previous_agent_status);
        focus_changed
    }

    pub(crate) fn emit_focus_status_change(
        &mut self,
        ws_idx: usize,
        pane_id: crate::layout::PaneId,
        previous_agent_status: Option<crate::api::schema::AgentStatus>,
    ) {
